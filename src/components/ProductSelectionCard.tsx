...
export default function ProductSelectionCard({ product }: Props) {
  const compareUrl = `/compare?name=${encodeURIComponent(product.name)}&brand=${encodeURIComponent(product.brand)}&q=${encodeURIComponent(product.searchQuery)}&min=${product.priceMin}&max=${product.priceMax}`;
